...
import { LogIn, Mail, Lock, User, AlertCircle, Sparkles, ShoppingCart } from "lucide-react";
...
export default function AuthModal({ onSuccess, onGuestAccess }: AuthModalProps) {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError("La connexion avec Google a échoué. Essayez l'e-mail ou le mode invité.");
    } finally {
      setLoading(false);
    }
  };
